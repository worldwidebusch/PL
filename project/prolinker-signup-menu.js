  ...
  class ProLinkerSignupMenu extends HTMLElement {
    ...
    render() {
      ...
      style.textContent = [
        ...
        '.trigger{min-height:38px;display:inline-flex;align-items:center;justify-content:center;padding:0 15px;border:1px solid #e88300;border-radius:3px;background:#e88300;color:#fff;font-size:13px;font-weight:700;line-height:1;white-space:nowrap;cursor:pointer}',
        '.trigger:hover{border-color:#cb7300;background:#cb7300}',
        '.trigger:focus-visible,.option:focus-visible{outline:3px solid rgba(232,131,0,.28);outline-offset:2px}',
        '.panel{position:absolute;right:0;top:calc(100% + 7px);z-index:140;width:206px;max-width:calc(100vw - 28px);display:grid;gap:7px;padding:10px 12px;border:1px solid var(--border,#dbe2e8);border-radius:4px;background:var(--surface,#fff);box-shadow:0 12px 28px -16px rgba(16,37,50,.48)}',
        '.panel[hidden]{display:none}',
        '.option{width:100%;min-height:32px;display:flex;align-items:center;justify-content:center;padding:6px 10px;border:1px solid transparent;border-radius:2px;color:#fff;text-align:center;text-decoration:none;font-size:11.5px;font-weight:700;line-height:1.2;white-space:normal;cursor:pointer}',
        '.freelancer{border-color:#e88300;background:#e88300}',
        '.freelancer:hover{border-color:#cb7300;background:#cb7300}',
        '.client{border-color:#5992c2;background:#5992c2}',
        '.client:hover{border-color:#477ead;background:#477ead}',
